<?php
  /* --------------------------------------------------------------
   $Id: categories.php 11251 2018-06-11 10:09:50Z GTB $
  ...
  switch ($action) {
    ...
    case 'multi_action_confirm' :
      ...
      if (isset ($_POST['multi_delete_confirm'])) {
        ...
        if (isset($_POST['multi_products']) && is_array($_POST['multi_products']) && isset($_POST['multi_products_categories']) && is_array($_POST['multi_products_categories'])) {
          foreach ($_POST['multi_products'] AS $product_id) {
      ...
      if (isset ($_POST['multi_move_confirm'])) {
        ...
        if (isset($_POST['multi_categories']) && is_array($_POST['multi_categories']) && isset($_POST['move_to_category_id']) && xtc_not_null($_POST['move_to_category_id'])) {
          foreach ($_POST['multi_categories'] AS $category_id) {
        ...
        //move multi_products
        if (isset($_POST['multi_products']) && is_array($_POST['multi_products']) && isset($_POST['move_to_category_id']) && xtc_not_null($_POST['move_to_category_id']) && isset($_POST['src_category_id']) && xtc_not_null($_POST['src_category_id'])) {
          foreach ($_POST['multi_products'] AS $product_id) {
      ...
      if (isset ($_POST['multi_copy_confirm'])) {
        ...
        if (isset($_POST['multi_categories']) && is_array($_POST['multi_categories']) && ( (isset($_POST['dest_cat_ids']) && is_array($_POST['dest_cat_ids'])) || (isset($_POST['dest_category_id']) && xtc_not_null($_POST['dest_category_id'])) )) {
        ...
        //copy multi_products
        if (isset($_POST['multi_products']) && is_array($_POST['multi_products']) && ( (isset($_POST['dest_cat_ids']) && is_array($_POST['dest_cat_ids'])) || (isset($_POST['dest_category_id']) && xtc_not_null($_POST['dest_category_id'])) )) {
          foreach ($_POST['multi_products'] AS $product_id) {
            $product_id = xtc_db_prepare_input($product_id);
            if (is_array($_POST['dest_cat_ids'])) {
              foreach ($_POST['dest_cat_ids'] AS $dest_category_id) {

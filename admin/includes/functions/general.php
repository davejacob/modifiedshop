<?php
  /* --------------------------------------------------------------
   $Id: general.php 12549 2020-01-29 15:31:02Z GTB $
  ...
  */
  ...
  function xtc_get_products_special_price($product_id){
    $product_query = xtc_db_query("SELECT specials_new_products_price
                                    ...
                                    WHERE products_id = '" . (int)$product_id . "'
                                      AND status = '1'
                                      AND (now() >= start_date OR start_date IS NULL)");
    $product = xtc_db_fetch_array($product_query);
   ...
   *   'geoplugin_region' => 'Baden-W�rttemberg',
   ...
   *   'geoplugin_regionName' => 'Baden-W�rttemberg',
